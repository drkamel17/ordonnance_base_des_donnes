// schema-risque-hemorragique-certificat.js
...
window.addEventListener('certDataReady', function () {
    ...
    const saveButton = document.getElementById('saveSchemaRisqueHemorragiqueButton');
    if (saveButton) {
        saveButton.addEventListener('click', function () {
            console.log("Clic sur le bouton de sauvegarde Risque Hemorragique.");
            ...
            if (typeof envoyerMessageNatifRabique === 'function') {
                ...
                envoyerMessageNatifRabique(data)
                    .then(() => {
                        console.log("Sauvegarde du certificat Risque Hemorragique réussie.");
                        alert("✅ Succès !\n\nLe certificat antirabique (Risque Hemorragique) a été sauvegardé.");
                    })
                    .catch(err => {
                        console.error("Erreur lors de la sauvegarde du certificat Risque Hemorragique:", err);
